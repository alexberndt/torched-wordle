...
def test_basic():
    ...
    assert game.guess("spoil") == [r.GREEN, r.GREEN, r.GREY, r.YELLOW, r.YELLOW]
...
def test_answer_crimp():
    ...
    assert game.guess("raise") == [r.YELLOW, r.GREY, r.GREEN, r.GREY, r.GREY]
    assert game.guess("mount") == [r.YELLOW, r.GREY, r.GREY, r.GREY, r.GREY]
    assert game.guess("grime") == [r.GREY, r.GREEN, r.GREEN, r.GREEN, r.GREY]
    assert game.guess("crimp") == [r.GREEN, r.GREEN, r.GREEN, r.GREEN, r.GREEN]